...
<!-- 1. MERAPATKAN JARAK KE NAVBAR (pt-5 mt-4 mb-5) -->
<div class="container-fluid pt-5 mt-4 mb-5">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-2">
                                    ...
                                    {{-- 2. TOMBOL EDIT SAYA KELUARKAN DARI IF AGAR BISA DIKLIK KAPAN SAJA --}}
                                    ...
                                    @if($sale->status != 'COMPLETED')
                                    {{-- Hapus tetap dikunci hanya untuk yang belum COMPLETED --}}
